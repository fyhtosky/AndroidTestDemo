package com.example.network_sdk.net.transformer;

import android.util.Log;

import com.example.network_sdk.movie.bean.MovieSubject;
import com.example.network_sdk.net.exception.ExceptionHandle;
import com.example.network_sdk.net.exception.ServerException;
import com.example.network_sdk.net.response.HttpResponse;
...
//            对请求服务器出现错误信息进行拦截
     ...
     * 双重校验锁单例(线程安全)
     */
    public static <T> Observable.Transformer<? super MovieSubject, ? extends MovieSubject> getInstance() {
        if (instance == null) {
